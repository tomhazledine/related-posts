...
related:
  - relativePath: 2022-02-25-wordle-node-script
    ...
    summary:
      - This is similar to what you've just read because, like the Minesweeper
        post, it explores using coding and data analysis to optimize gameplay
        and enhance player experience, this time with the popular word game,
        Wordle.
    score: 0.7837641217986089
  - relativePath: 2017-01-20-bullet-journal-revisited
    ...
    excerpt: The Bullet Journal is a system for Getting Things Done. One nested
      pen-and-paper list that gets rewritten every morning.
    summary:
      - This is similar to what you've just read because it discusses the
        development and fine-tuning of a system - in this case, a productivity
        tool - based on feedback and personal preferences, much like how the
        author adjusted the rules and features of the Minesweeper game in the
        first post.
    score: 0.7628795255605386
