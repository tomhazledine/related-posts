...
related:
  - relativePath: 2015-05-31-inline-svg-icons
    ...
    excerpt: As a typography nerd, using a custom font to serve icons felt really
      ...
      way.
    summary:
      - This is similar to what you've just read because it provides additional
        insights on the transition from icon fonts to SVG sprites, adds
        practical examples on how to use SVG sprites in Jekyll and Wordpress,
        and reinforces the idea of SVG sprites being advantageous in terms of
        website performance and ease of maintenance.
    score: 0.9469621901606602
  - relativePath: 2017-02-15-svg-markup
    ...
    summary:
      - This is similar to what you've just read because it further explores the
        benefits of using SVGs, adds depth to the understanding of SVG markup
        and emphasizes the potential for creativity and design control using
        SVGs and CSS, which complements the discussion on SVG icon sprites.
